...
class LoginScreen extends Component {
  ...
  componentDidMount() {
    ...
    if (token && this.props.isAuth && this.props.userData.user_role === "admin") {
      this.props.history.push(routes.admin.dashboard);
    }
  }
  ...
  login = async (e) => {
    ...
    const result = await API.post("/admin/login", fd);
